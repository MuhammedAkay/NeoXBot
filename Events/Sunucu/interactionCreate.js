      ...
      if (slashCommand.userPerms || slashCommand.botPerms) {
        if (
          ...
          const userPerms = new EmbedBuilder()
            .setDescription(
              `🚫 ${interaction.user}, Bu Komutu Kullanabilmen İçin \`${slashCommand.userPerms}\` İznine Veya İzinlerine Sahip Olmalısın!`
            )
            .setColor("Red");
        ...
        if (
          ...
          const botPerms = new EmbedBuilder()
            .setDescription(
              `🚫 ${interaction.user}, Bu Komutu Çalıştırmam İçin \`${slashCommand.botPerms}\` İznine Sahip Olmam Lazım!`
            )
            .setColor("Red");
